...
{
    public class DmLopHocController : BaseController
    {
        private LibDBContext db = new LibDBContext();

        // GET: AdminCP/DmLopHoc
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("dm_lop_hoc", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmLopHoc/Details/5
        ...
        // GET: AdminCP/DmLopHoc/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmLopHoc/Create
        ...
        // POST: AdminCP/DmLopHoc/Delete/5
