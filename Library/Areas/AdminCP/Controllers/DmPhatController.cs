...
{
    public class DmPhatController : BaseController
    {
        ...
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            ...
            var model = ds.ListAll("lib_dm_ly_do_phat", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmPhat/Details/5
        ...
        // GET: AdminCP/DmPhat/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmPhat/Create
