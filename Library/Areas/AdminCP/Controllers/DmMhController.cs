...
{
    public class DmMhController : BaseController
    {
        ...
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            ...
            var model = ds.ListAll("dm_mon_hoc", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmMh/Details/5
        ...
        // GET: AdminCP/DmMh/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmMh/Create
