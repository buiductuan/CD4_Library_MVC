...
{
    public class DmNguonCCController : BaseController
    {
        private LibDBContext db = new LibDBContext();

        // GET: AdminCP/DmNguonCC
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("lib_dm_nha_cung_cap", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmNguonCC/Details/5
        ...
        // GET: AdminCP/DmNguonCC/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmNguonCC/Create
        ...
        // GET: AdminCP/DmNguonCC/Delete/5
        ...
        // POST: AdminCP/DmNguonCC/Delete/5
