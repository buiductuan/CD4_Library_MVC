...
{
    public class DmTinhTrangController : BaseController
    {
        private LibDBContext db = new LibDBContext();

        // GET: AdminCP/DmTinhTrang
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("lib_dm_tinh_trang", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmTinhTrang/Details/5
        ...
        // GET: AdminCP/DmTinhTrang/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmTinhTrang/Create
        ...
        // GET: AdminCP/DmTinhTrang/Edit/5
        ...
        // POST: AdminCP/DmTinhTrang/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminCP/DmTinhTrang/Delete/5
        ...
        // POST: AdminCP/DmTinhTrang/Delete/5
