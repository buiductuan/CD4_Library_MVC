...
namespace Library.Areas.AdminCP.Controllers
{
    public class DmCapHocController : BaseController
    {
        ...
        // GET: AdminCP/DmCapHoc
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("dm_cap_hoc", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmCapHoc/Details/5
        ...
        // GET: AdminCP/DmCapHoc/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmCapHoc/Create
        ...
        // POST: AdminCP/DmCapHoc/Delete/5
