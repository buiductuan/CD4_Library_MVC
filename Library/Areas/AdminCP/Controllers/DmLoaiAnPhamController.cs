...
namespace Library.Areas.AdminCP.Controllers
{
    public class DmLoaiAnPhamController : BaseController
    {
        ...
        // GET: AdminCP/DmLoaiAnPham
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("lib_dm_phan_loai", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmLoaiAnPham/Details/5
        ...
        // GET: AdminCP/DmLoaiAnPham/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmLoaiAnPham/Create
        ...
        // GET: AdminCP/DmLoaiAnPham/Edit/5
        ...
        // POST: AdminCP/DmLoaiAnPham/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminCP/DmLoaiAnPham/Delete/5
        ...
        // POST: AdminCP/DmLoaiAnPham/Delete/5
