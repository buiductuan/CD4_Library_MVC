...
{
    public class DmKhoNgonNguController : BaseController
    {
        private LibDBContext db = new LibDBContext();

        // GET: AdminCP/DmKhoNgonNgu
        public ActionResult Index(int page = 1, int pagesize = 10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("lib_dm_ngon_ngu", page, pagesize);
            return View(model);
        }

        // GET: AdminCP/DmKhoNgonNgu/Details/5
        ...
        // GET: AdminCP/DmKhoNgonNgu/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmKhoNgonNgu/Create
        ...
        // GET: AdminCP/DmKhoNgonNgu/Edit/5
        ...
        // POST: AdminCP/DmKhoNgonNgu/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminCP/DmKhoNgonNgu/Delete/5
        ...
        // POST: AdminCP/DmKhoNgonNgu/Delete/5
