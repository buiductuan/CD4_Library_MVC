...
{
    public class DmTacGiaController : BaseController
    {
        private LibDBContext db = new LibDBContext();

        // GET: AdminCP/DmTacGia
        public ActionResult Index(int page=1, int pagesize=10)
        {
            var ds = new DmChungModel();
            var model = ds.ListAll("lib_dm_tac_gia",page,pagesize);
            return View(model);
        }

        // GET: AdminCP/DmTacGia/Details/5
        ...
        // GET: AdminCP/DmTacGia/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminCP/DmTacGia/Create
        ...
        // POST: AdminCP/DmTacGia/Delete/5
