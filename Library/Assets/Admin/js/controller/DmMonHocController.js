var DmMonHocController = {
    init: function () {
        DmMonHocController.registerEvent();
    },
    registerEvent: function () {
        ...
        function LoadData() {
            ...
            $('#dm_parent').html("");
            $.getJSON('/AdminCP/DmMonHoc/getList', function (data) {
        ...
        $(document).delegate('.btn_update', 'click', function (e) {
            ...
            $.get("/AdminCP/DmMonHoc/getARecord?id=" + id, function (data) {
                var dm = data.split("#");
                $('#ID_hide').val(dm[0]);
                $('#ten').val(dm[1]);
                $('#kyhieu').val(dm[2]);
        ...
        $(document).delegate('.btn_detail', 'click', function (e) {
            ...
            $.get("/AdminCP/DmMonHoc/getADetail?id=" + id, function (data) {
                var dm = data.split("#");
        ...
        $('#btn_update_modal').off('click').on('click', function (e) {
            ...
            $.post("/AdminCP/DmMonHoc/postUpdate", bm, function (data) {
                if (data) {
                    CloseModal();
        ...
        $('#btn_create_modal').off('click').on('click', function (e) {
            ...
            console.log(data);
            if (ma != "" && ten != "" && ky_hieu != "") {
                $.post("/AdminCP/DmMonHoc/postCreate",
        ...
        $(document).delegate('.btn_delete', 'click', function (e) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result) {
                        $.get('/AdminCP/DmMonHoc/getDelete?id=' + ma, function (data) {
                            if (data) {
